...
export const handlePrismaClientKnownRequestError = (error: Prisma.PrismaClientKnownRequestError) : TErroResponse => {
...
export const handlePrismaClientUnknownError = (error: Prisma.PrismaClientUnknownRequestError) : TErroResponse => {
    let cleanMessage = error.message;
...
export const handlePrismaClientValidationError = (error: Prisma.PrismaClientValidationError) : TErroResponse => {
    let cleanMessage = error.message;
...
export const handlerPrismaClientInitializationError = (error: Prisma.PrismaClientInitializationError) : TErroResponse => {
...
export const handlerPrismaClientRustPanicError = () : TErroResponse => {
    const errorSources : TErrorSources[] = [{
