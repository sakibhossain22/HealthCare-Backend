...
import { AppoinmentStatus, PaymentStatus, UserRole } from "../../../generated/prisma/enums";
...
const changeAppointmentStatus = async (appointmentId: string, appointmentStatus: AppoinmentStatus, user: IRequestUser) => {
...
const initiatePayment = async (appointmentId: string, user: IRequestUser) => {
    ...
    if (appointmentData.status === AppoinmentStatus.CANCELLED) {
